...
export default async function DatenschutzPage() {
  ...
  const ds = co?.datenschutzContact as
  ...
  const variables: Record<string, string> = co
    ? {
        ...
        dsName: ds
          ...
          : (co.geschaeftsfuehrer ?? co.companyName),
        dsEmail: ds?.email ?? co.email,
      }
    : {}

  return (
    <main>
      <Hero text={page?.heroTitle || 'Datenschutz'} />
